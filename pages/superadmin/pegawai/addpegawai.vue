                ...
                <form @submit.prevent="SaveData">
                  ...
                  <div class="relative mb-4" data-te-input-wrapper-init>
                    ...
                    <select
                      ...
                      <option selected>Pilih akun pegawai</option>
                  ...
                  <div class="relative mb-4" data-te-input-wrapper-init>
                    ...
                    <div id="app">
                      <input
                        type="radio"
                        name="test_id"
                        v-model="employes.jenis_kelamin"
                  ...
                  <div class="relative mb-4" data-te-input-wrapper-init>
                    ...
                    <input
                      type="text"
                      v-model="employes.nomor_telepon"
                      class="bg-white appearance-none border-2 border-teal-400 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-teal-50 focus:border-teal-500"
                      id="inputTelepon"
                      placeholder="telepon" />
                  </div>
      ...
      SaveData() {
        axios
          ...
          .then((res) => {
            ...
            this.employes.user_uuid = "";
            this.employes.nip = "";
            this.employes.jenis_kelamin = "";
            this.employes.alamat = "";
            this.employes.dusun = "";
            this.employes.jabatan = "";
            this.employes.nomor_telepon = "";
          });
      },
    },
  };
